...
The Open System Interconnection model (OSI) is a layered model for computer
communication. There are 7 layers, from physical to application, that pass data
to the layer above and receive data from the layer below. Layers are organized
...
<tbody>
<tr>
<td class="org-left">7-Application</td>
<td class="org-left">Application the user interacts with</td>
<td class="org-left">Web browser</td>
</tr>


<tr>
<td class="org-left">6-Presentation</td>
<td class="org-left">Encryption and Encoding</td>
<td class="org-left">HTTP / HTML / GZIP</td>
</tr>


<tr>
<td class="org-left">5-Session</td>
<td class="org-left">Maintain connection - dialogues</td>
<td class="org-left">HTTP connection over TCP session</td>
</tr>


<tr>
<td class="org-left">4-Transport</td>
<td class="org-left">Transmission and re-transmission on errors</td>
<td class="org-left">TCP/UDP - cut the web pages in segments/datagrams</td>
</tr>


<tr>
<td class="org-left">3-Network</td>
<td class="org-left">Addressing and routing</td>
<td class="org-left">IP routing segments/datagrams across packets</td>
</tr>


<tr>
<td class="org-left">2-Link</td>
<td class="org-left">Transmission on a physical medium with error correction</td>
<td class="org-left">Network card sending packets across frames</td>
</tr>


<tr>
<td class="org-left">1-Physical</td>
<td class="org-left">Raw bit stream</td>
<td class="org-left">copper / fiber / ether</td>
</tr>
</tbody>
</table>

For the sake of simplicity we consider layers 5-6-7 to be condensed into only
...
DDoS usually arise on OSI layer 3/4 and aims at clogging the network between the
...
Amplification attacks usually arise on layers 3 and 4 and are therefore Network
Denial of Service attacks.
...
These kind of attack focus on the application (layer 7 of OSI) and are therefore
...
discuss in the next articles. Stay tuned.
